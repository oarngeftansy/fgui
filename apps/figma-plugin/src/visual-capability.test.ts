...
describe("visual capability classification", () => {
  it.each([
    ...
    ["nonuniform rectangle corners", node({ type: "RECTANGLE", fills: [{ type: "SOLID", color: { r: 1, g: 0, b: 0 } }], topLeftRadius: 2, topRightRadius: 4 }), false, "composite_png", "image/png", ["visual_style"]],
